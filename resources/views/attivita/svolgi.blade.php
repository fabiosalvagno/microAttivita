...
<body class="bg-gray-50">
    ...
    <script>
        ...
        function showResults() {
            // Ferma il timer e nasconde i contenitori
            if (timerInterval) clearInterval(timerInterval);
            timerContainerEl.classList.add('hidden');
            timerBarContainerEl.classList.add('hidden');
            audioContainerEl.classList.add('hidden');
            ...
            // --- INIZIO MODIFICA ---
            // Abbiamo rimosso il blocco "if" che disabilitava il bottone.
            // Ora il bottone "Riprova" è SEMPRE attivo, anche se il tempo è scaduto.
